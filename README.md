...
The **Uniquery** library is designed to be a versatile query translation library that can be integrated into various programs. Its main functionality is to accept a Unified Query Language (UQL) and translate it into database-specific query formats.
